...
- `TextProcessorTool`: uppercase, lowercase, titlecase, word count, character count
- `CalculatorTool`: safe arithmetic without `eval`
- `WeatherMockTool`: deterministic mock weather responses
- `CurrencyConverterTool`: fixed-rate mock currency conversion
- `TransactionCategorizerTool`: keyword-based transaction categorization
